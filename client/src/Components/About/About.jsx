  ...
  return (
    <div className={s.allContainer}>
      ...
      <div className={s.paragraph}>
        ...
        tecnología, pero los métodos convencionales de contratación no parecen
        alinearse con tus ritmos o necesidades...
      </div>

      <h4 className={s.subTitle}>¡El sitio para vos!</h4>

      <div className={s.paragraph}>
        En Programax, podrás postularte y encontrar a los desarrolladores que
        cubran tus necesidades... ¡Al alcance de un click!
      </div>

      <div className={s.paragraph}>
        Contacta al desarrollador ideal, hazle una oferta, y paga por su trabajo
        de manera segura y sin costo adicional... ¡Y todo en un solo sitio!
      </div>
      ...
      <div className={s.paragraph}>
        Comprendemos que, en el mundo de la tecnología, las necesidades de los
        usuarios y los prestadores de servicios IT, no siempre se encuentran
        fácilmente entre sí. Por ello, decidimos encontrarlos en nuestro sitio,
        y facilitar la adquisición de servicios de forma simple, y eficaz.
      </div>
