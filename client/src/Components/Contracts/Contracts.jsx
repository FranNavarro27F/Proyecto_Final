  ...
  return (
      <div>
        ...
        <form  onSubmit={ e =>handleSubmit(e)}>
            ...
            <input type={"date"} name={"date"} value={contrato.date} onChange={(e)=>handleChange (e)}/>
            
            <label>Fecha fin:</label>
            <input type={"date"} name ={"expiration_date"} value={contrato.expiration_date} onChange={(e)=>handleChange(e)} />

            <label>Descripción</label>
            <input type="text-area" name= {"description"} value ={contrato.description} onChange={(e)=>handleChange(e)}/>

            <label>Precio</label>
            <input type ={"number"} name={"price"} value={contrato.price} onChange={(e)=>handleChange(e)}></input>
