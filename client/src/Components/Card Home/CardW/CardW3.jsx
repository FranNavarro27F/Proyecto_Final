...
import s from "./CardW3.module.css";

export default function CardW3({ userPremium }) {
  return (
    <div className={s.divcard3}>
        ...
        >
          <g filter="url(#filter0_b_39_329)">
            ...
            <rect
              ...
              height="279"
              rx="29.5"
              stroke="url(#paint1_linear_39_329)"
              strokeOpacity="0.3"
            />
          </g>
          <defs>
            ...
            >
              ...
              <feComposite
                in2="SourceAlpha"
                operator="in"
                result="effect1_backgroundBlur_39_329"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_backgroundBlur_39_329"
                result="shape"
              />
            </filter>
            <pattern
